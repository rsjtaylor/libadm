...
namespace adm {
  ...
  template <typename... Parameters>
  CartesianSpeakerPosition::CartesianSpeakerPosition(Parameters... optionalNamedArgs) {
  ...
  template <typename... Parameters>
  SphericalSpeakerPosition::SphericalSpeakerPosition(Parameters... optionalNamedArgs) {
    detail::setNamedOptionHelper(
        this, std::forward<Parameters>(optionalNamedArgs)...);
  }
