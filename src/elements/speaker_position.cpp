...
namespace adm {
  ...
  XMin CartesianSpeakerPosition::get(
      detail::ParameterTraits<XMin>::tag) const {
    return xMin_.get();
  }
  XMax CartesianSpeakerPosition::get(
      detail::ParameterTraits<XMax>::tag) const {
    return xMax_.get();
  }
  Y CartesianSpeakerPosition::get(
      detail::ParameterTraits<Y>::tag) const {
    return y_;
  }
  YMin CartesianSpeakerPosition::get(
      detail::ParameterTraits<YMin>::tag) const {
    return yMin_.get();
  }
  YMax CartesianSpeakerPosition::get(
      detail::ParameterTraits<YMax>::tag) const {
    return yMax_.get();
  }
  Z CartesianSpeakerPosition::get(detail::ParameterTraits<Z>::tag) const {
    return z_.get();
  }
  ZMin CartesianSpeakerPosition::get(
      detail::ParameterTraits<ZMin>::tag) const {
    return zMin_.get();
  }
  ZMax CartesianSpeakerPosition::get(
      detail::ParameterTraits<ZMax>::tag) const {
    return zMax_.get();
  }
  ...
  void CartesianSpeakerPosition::set(YMin yMin) {
    yMin_ = yMin;
  }
  void CartesianSpeakerPosition::set(YMax yMax) {
    yMax_ = yMax;
  }
  void CartesianSpeakerPosition::set(Z z) { z_ = z; }
  void CartesianSpeakerPosition::set(ZMin zMin) {
    zMin_ = zMin;
  }
  void CartesianSpeakerPosition::set(ZMax zMax) {
    zMax_ = zMax;
  }
  ...
  void CartesianSpeakerPosition::unset(detail::ParameterTraits<ScreenEdgeLock>::tag) {
    screenEdgeLock_ = boost::none;
  }

  // ---- Getter ---- //
  Azimuth SphericalSpeakerPosition::get(detail::ParameterTraits<Azimuth>::tag) const {
    return azimuth_;
  }
  ...
  Distance SphericalSpeakerPosition::get(detail::ParameterTraits<Distance>::tag) const {
  ...
  // ---- Has ---- //
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<Azimuth>::tag) const {
    return true;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<AzimuthMin>::tag) const {
    return azimuthMin_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<AzimuthMax>::tag) const {
    return azimuthMax_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<Elevation>::tag) const {
    return true;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<ElevationMin>::tag) const {
    return elevationMin_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<ElevationMax>::tag) const {
    return elevationMax_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<Distance>::tag) const {
    return distance_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<DistanceMin>::tag) const {
    return distanceMin_ != boost::none;
  }
  bool SphericalSpeakerPosition::has(detail::ParameterTraits<DistanceMax>::tag) const {
  ...
  void SphericalSpeakerPosition::set(AzimuthMin azimuthMin) { azimuthMin_ = azimuthMin; }
  void SphericalSpeakerPosition::set(AzimuthMax azimuthMax) { azimuthMax_ = azimuthMax; }
  void SphericalSpeakerPosition::set(Elevation elevation) { elevation_ = elevation; }
  ...
  void SphericalSpeakerPosition::set(Distance distance) { distance_ = distance; }
  ...
  // ---- Unsetter ---- //
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<AzimuthMin>::tag) {
    azimuthMin_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<AzimuthMax>::tag) {
    azimuthMax_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<ElevationMin>::tag) {
    elevationMin_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<ElevationMax>::tag) {
    elevationMax_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<Distance>::tag) {
    distance_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<DistanceMin>::tag) {
    distanceMin_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<DistanceMax>::tag) {
    distanceMax_ = boost::none;
  }
  void SphericalSpeakerPosition::unset(detail::ParameterTraits<ScreenEdgeLock>::tag) {
    screenEdgeLock_ = boost::none;
  }
